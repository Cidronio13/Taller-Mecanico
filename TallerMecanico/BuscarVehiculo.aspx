<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BuscarVehiculo.aspx.cs" Inherits="TallerMecanico.BuscarVehiculo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row mb-3">
        <div class="col-md-8">
            <label for="TxtFiltro" class="form-label">Filtrar por Modelo</label>
